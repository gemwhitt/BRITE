...
filesin=file_search(indir+'*hpmaps2.sav', count=nf)

for f=0, 0 do begin ;nf-1 do begin
  
  restore, filesin[f] ;data1, hps2
  ...
  ; now plot both
  for im=9887, 9887+299 do begin  
    wset, 0
    plot_image, bytscl(data2[*,*,im], 20, 500), title=strtrim(im,2), color=cgcolor('black')   
    wait, 0.5
  endfor
