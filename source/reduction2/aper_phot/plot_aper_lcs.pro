pro plot_aper_lcs
 ...
 ; indir='~/BRITE/'+sat+'/'+field+'/data/aper_lc_intpix/'
  ...
  for f=0, nf-1 do begin
    ...
    ;readcol, filein[f], jd, flux, eflux, xcen, ycen, avgtemp, vmag, bmag, npix_psf, format='d,d,d,f,f,f,f,f,i'
    readcol, filein[f], jd, flux, xcen, ycen, avgtemp, vmag, bmag, npix_psf, format='d,d,f,f,f,f,f,i'
    ...
    wset, 0
    plot, jd1, mags, color=cgcolor('black'), psym=2, /YNOZERO
    stop
