pro thermal_testing2
  ...
  for i=0, ntimes-1 do begin
    ...
    for j=0, nfits-1 do begin
      ...
      hot_int[j,*]=data[reordered_data[20:29]]
      
      hot_loc=reordered_data[20:29]
      
    endfor
    
    fileout=outdir+'hotpix_'+times[i]+'.txt'
    ...
    for jj=0, 9 do printf, lun, hot_loc[jj]
    printf, lun, 'HP_Intensities'
    for jj=0, 3 do printf, lun, hot_int[jj,*], format='(d10.2,x,d10.2,x,d10.2,x,d10.2,x,d10.2,x,d10.2,x,d10.2,x,d10.2,x,d10.2,x,d10.2)'
    free_lun, lun
